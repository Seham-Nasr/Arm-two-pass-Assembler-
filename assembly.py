    ...
    for LC in InstructionLine:
        ...
        if lineList[1].lower() in opcodes:
            ...
            if cat == 'REGOP':
                ...
                if len(lineList[2:]) < 2:
                    #___________________________Error
                    print('Not enough number of operands in Line: ',orgLineNumber)  # Error
                    errorFlag = True
...
#                                print(BinToHex(instruction_machine))
                ...
                if noOfoperand != 3:
                    #Error 
                    print('swp or swpb must have 3 registers operands error in line :',orgLineNumber) #Error
                    errorFlag = True
                    error.update(flag=True, type='Invalid No. of Operand', lineNo=orgLineNumber)
                    errorList.append(error.copy())
                    continue
...
#                print(BinToHex(instruction_machine))
                ...
                if op[2] == 'a':
                    if noOfoperand != 4:
                        print('mla must have 4 registers operands; invalid No. of Operand in line: ',orgLineNumber)  # Error
                        errorFlag = True
                        error.update(flag=True, type='Invalid No. of Operand', lineNo=orgLineNumber)
                        errorList.append(error.copy())
                        orgLineNumber += 1
...
#                        print(BinToHex(instruction_machine))
                    ...
                    if noOfoperand != 3:
                        print('mul must have 3 registers operands,invalid No. of Operand in line: ',orgLineNumber)  # Error
                        errorFlag = True
                        error.update(flag=True, type='Invalid No. of Operand', lineNo=orgLineNumber)
                        errorList.append(error.copy())
                        orgLineNumber += 1
...
#                    print(BinToHex(instruction_machine))
                    ...
                    print("Undefined symbol in line: ", orgLineNumber)
                    errorFlag = True
